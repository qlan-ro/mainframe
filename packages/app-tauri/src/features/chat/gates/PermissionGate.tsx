...
function ToolNameRow({ toolName }: { toolName: string }) {
  return (
    <div className="flex items-center gap-2 px-3.5 pb-2 pl-12">
    ...
    <div className="px-3.5 pb-3 pl-12">
      ...
      {open && (
        <pre
          ...
          className="mt-2 max-h-60 overflow-auto rounded-md bg-mf-raised p-3 font-mono text-caption text-foreground"
        >
