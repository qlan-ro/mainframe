 ...
 * an arbitrary buffer). Code blocks render as plain styled <pre> — no shiki
 * highlighting in the preview (the chat path keeps shiki).
 */
...
const components = {
  ...
  pre: (p: ElProps<'pre'>) => (
    <pre
      {...p}
      className="my-2 overflow-x-auto rounded-md border border-border bg-mf-code-bg p-3 font-mono text-caption text-mf-code-fg"
    />
  ),
