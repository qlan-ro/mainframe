...
describe('ProviderTuningDefaults', () => {
  it('renders default-effort select + supported feature toggles, capability-gated', () => {
    render(<ProviderTuningDefaults adapterId="claude" model={fullModel} config={emptyConfig} onChange={vi.fn()} />);
  ...
  it('does not render effort select when model has no supportedEfforts', () => {
    ...
    render(
      <ProviderTuningDefaults adapterId="claude" model={modelNoEfforts} config={emptyConfig} onChange={vi.fn()} />,
    );
  ...
  it('does not render feature toggles when model has no capabilities', () => {
    ...
    render(
      <ProviderTuningDefaults adapterId="claude" model={modelNoFeatures} config={emptyConfig} onChange={vi.fn()} />,
    );
...
describe('CodexTuningDefaults', () => {
  it('shows personality + reasoning summary (no verbosity)', () => {
    ...
    render(<CodexTuningDefaults adapterId="codex" model={codexModel} config={emptyConfig} onChange={vi.fn()} />);
  ...
  it('hides personality select when model does not supportsPersonality', () => {
    ...
    render(<CodexTuningDefaults adapterId="codex" model={modelNoPers} config={emptyConfig} onChange={vi.fn()} />);
