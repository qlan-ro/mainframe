...
describe('ToolFallbackTrigger running shimmer', () => {
  it('overlay geometry matches the base label so it does not ghost (text-xs + font-medium)', () => {
    render(
    ...
    // (text-xs 11px + font-medium 500), else it renders wider (13px/700)
    // and misaligns into doubled "Used tool: X" ghosting.
    expect(shimmer!.className).toContain('text-xs');
