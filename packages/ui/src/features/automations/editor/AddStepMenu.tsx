 ...
 * empty on purpose).
 *
 * The trigger is wrapped in `Hint` (wraps, never sits inside — see
 * `TokenPicker`'s identical binding convention), not because its own label
 * is unclear, but for consistency with every other popover trigger in this
 * feature.
 */
