...
const SOURCE_STYLE: Record<TokenSourceKind, SourceStyle> = {
  ...
  trigger: {
    ...
    borderClass: 'border-mf-auto-kind-call/30',
  },
  agent: { icon: Sparkles, iconClass: 'text-primary', tintClass: 'bg-primary/12', borderClass: 'border-primary/30' },
  askme: {
    icon: MessageCircle,
    iconClass: 'text-mf-auto-kind-question',
    tintClass: 'bg-mf-auto-kind-question/12',
    borderClass: 'border-mf-auto-kind-question/30',
  },
  action: {
    icon: Plug,
