        ...
        {shown.map((action) => {
          ...
          return (
            <button
              ...
              className="flex items-start gap-2.5 rounded-md border-[0.5px] border-border bg-card p-2.5 text-left hover:border-input hover:bg-accent disabled:cursor-not-allowed disabled:opacity-45 disabled:hover:border-border disabled:hover:bg-card"
            >
              <span
