 ...
 * The knockout is white in both themes for the same reason.
 */
...
function ProviderPath({ id }: { id: ProviderLogoId }) {
  switch (id) {
    ...
    case 'opencode':
      return <path d="M16 6H8v12h8V6zm4 16H4V2h16v20z" />;
    case 'unknown':
      return <path d="M12 1.8l2.4 7.8 7.8 2.4-7.8 2.4-2.4 7.8-2.4-7.8-7.8-2.4 7.8-2.4L12 1.8z" />;
  }
}
  ...
  return (
    ...
    >
      <svg
        ...
        className={avatar ? 'size-3/4' : 'size-full'}
      >
        <ProviderPath id={id} />
      </svg>
    </span>
